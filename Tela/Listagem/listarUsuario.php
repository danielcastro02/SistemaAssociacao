...
//                        -----------------------------------------------------------
                                if (($us->getPode_logar() == 'true')) {
                                    echo "<td>";
                                    ?>
                            <a class="btn corpadrao" href="../../Controle/usuarioControle.php?function=tornarUsuarioInativo&id=<?php echo $us->getIdPessoa(); ?>">Ativo</a>
                                       <?php
                                       echo "</td>";
                                   } else {
                                       echo "<td>";
                                       ?>
                                    <a class="btn red darken-2" href="../../Controle/usuarioControle.php?function=tornarUsuarioAtivo&id=<?php echo $us->getIdPessoa(); ?>">Inativo</a><?php
                                       echo "</td>";
                                   }
//                        -----------------------------------------------------------
